# Free Fly (Gen 2 camera fork)

> **This is a compatibility fork of
> [shanehudson-gen1recomp-mods/free_fly](https://github.com/shanehudson-gen1recomp-mods/free_fly),
> published under its own MIT licence.** It carries exactly one change
> against upstream 1.8.0: the flight camera now lifts on a Gen 2 boot.
> Everything else -- the mod, its design and all the credit -- is Shane
> Hudson's. Source for upstream lives in the
> [mods monorepo](https://github.com/shanehudson-gen1recomp-mods/monorepo).
>
> Prefer upstream if you play Gen 1. This exists because the Johto Diorama
> cart pairs flight with a voxel renderer on Crystal, where the bug is
> visible on the default camera rung. See the 1.8.1 entry in
> [CHANGELOG.md](CHANGELOG.md) for what was wrong and why it was invisible.
